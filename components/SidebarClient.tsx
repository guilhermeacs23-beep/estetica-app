...
const NAV: NavItem[] = [
  ...
  { href: "/orcamentos",        label: "Orçamentos", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16l3-3 3 3 3-3 3 3V4a2 2 0 0 0-2-2z"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/></svg> },
  ...
  { divider: true },
  {
    ...
    items: [
      ...
      { href: "/clientes/recap",  label: "📞 Recap de Clientes" },
