      ...
      <div className="card flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs mt-1" style={{ color:"var(--text-muted)" }}>Aplica em botões, badges e destaques do sistema</p>
          </div>
          <div className="flex items-center gap-3">
            <div style={{
              width: 32, height: 32, borderRadius: 8,
              background: corSelecionada, border: "2px solid var(--border)",
              flexShrink: 0,
            }} />
            <button
          ...
          <div className="flex flex-col gap-4 pt-2" style={{ borderTop: "1px solid var(--border)" }}>
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg" style={{ background: "var(--bg)" }}>
              <div style={{
                ...
                background: corSelecionada, flexShrink: 0,
              ...
              <button className="btn btn-sm ml-auto" style={{ background: corSelecionada, color: "#fff", border: "none", fontSize: 12 }}>
                Exemplo
              </button>
            </div>
                ...
                {CORES.map(c => (
                  <button
                    ...
                    style={{
                      ...
                      outline: corSelecionada === c.hex ? `3px solid var(--text)` : "2px solid transparent",
                      outlineOffset: 2,
                      transform: corSelecionada === c.hex ? "scale(1.2)" : "scale(1)",
